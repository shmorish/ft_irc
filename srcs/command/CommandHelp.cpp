...
void Command::help()
{
    ...
    else if (command == "INVITE") help_invite(_user);
    else if (command == "JOIN") help_join(_user);
    else if (command == "KICK") help_kick(_user);
    else if (command == "MODE") help_mode(_user);
    else if (command == "NICK") help_nick(_user);
    else if (command == "PART") help_part(_user);
    else if (command == "PASS") help_pass(_user);
    else if (command == "PING") help_ping(_user);
    else if (command == "PRIVMSG") help_privmsg(_user);
    else if (command == "QUIT") help_quit(_user);
    else if (command == "SENDFILE") help_sendfile(_user);
    else if (command == "TIME") help_time(_user);
    else if (command == "TOPIC") help_topic(_user);
    else if (command == "USER") help_user(_user);
    else if (command == "GETFILE") help_getfile(_user);
}